...
sprite_sheet = pygame.image.load(os.path.join(diretorio_imagens, 'Dino.png')).convert_alpha()
...
class Dino(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect.topleft = (20, self.pos_y_inicial) #368   416(centro y)
        self.pulo = False
...
class Cacto(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect.center = (LARGURA,  ALTURA - 66)
        self.rect.x = LARGURA
...
while True:
    ...
    if colidiu == True:
        ...
        restart = exibe_mensagem('Pressione a tecla r para reiniciar', 18, (0,0,0))
